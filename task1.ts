...
const fruits: { [fruit: string]: number } = {
  ...
  const vegetables: { [vegetable: string]: number } = {
    carrot: 1.50,
    tomato: 2.25,
    potato: 1.75,
  };
  
  const groceries: { [grocery: string]: number } = {
    milk: 3.80,
    bread: 2.50,
    eggs: 4.50,
  };
  ...
  const choice: string = promptSync("Enter your preference: ");
  ...
  if (choice === "fruits") {
    ...
    const fruitSelection: string = promptSync("Enter the fruit you want to buy: ");
    ...
    const vegetableSelection: string = promptSync("Enter the vegetable you want to buy: ");
    ...
    const grocerySelection: string = promptSync("Enter the grocery you want to buy: ");
  ...
  const paymentMethod: number = parseInt(promptSync("Enter your choice (1-3): "));
